...
if __name__ == "__main__":
    setup(
        ...
        description="A class to update and/or create a pdf object, and add pages to it. For now only matplotlib.figure "
                    "and tablewriter.TableWriter objects can be added.",
        long_description=long_description,
        long_description_content_type="text/markdown",
        url="https://github.com/Advestis/pdffactory",
